\name{showme}
\alias{showme} 
\title{Display Abbreviated Output Of FORSEARCH_LM Function 
}
\description{Output of forsearch_lm function can be voluminous. This function displays the 
...
\arguments{
  \item{x}{Name of forsearch_lm output file
}
