...
vignette: >
  %\VignetteIndexEntry{Quality Control of the Dataset}
...
To complicate matters further, regulatory agencies and others worry that data quality control is only undertaken after some unexpected, adverse findings are discovered in the study.  Eliminating observations at this point has the appearance of sampling to a foregone conclusion or eliminating adverse results.
