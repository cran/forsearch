     ...
     diagnose=FALSE, verbose=TRUE)
{
     ...
     if(verbose) {
          print("", quote = FALSE)
          print("Running plotdiag.tstats", quote = FALSE)
          print("", quote = FALSE)
...
##################################################   Main function    ##############################################
     ...
     #############################################################
     df1 <- forn$"t statistics"                                    # df1 already has a column of m
     mcolumn <- df1[,1]
     ndf1 <- dim(df1)[2]
     df1 <- df1[,-1]
     if(ndf1==2){
     ...
     if(verbose) {
          print("", quote = FALSE)
          print("Finished running plotdiag.tstats", quote = FALSE)
          print("", quote = FALSE)
          print(date(), quote = FALSE)
          print("", quote = FALSE)
     }
